# Модель БД
Сначала была разработана модель данных под одну из тем, а именно база данных для отслеживания рейсов вв аэропорту
После этого на основе этой модели были созданы модели данных django
![html страница](images/bd_model.PNG)
```python
