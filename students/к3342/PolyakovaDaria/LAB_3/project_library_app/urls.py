...
from .views import (
    ...
    UpdateBookCodeAPIView, UpdateReaderTicketAPIView, LowStockBooksAPIView
)
...
urlpatterns = [
    ...
    path('books/<int:book_copy_id>/transfer/', TransferBookAPIView.as_view(), name="transfer_book"),
