<template>
    <v-container class="profile">
      ...
      <v-row class="justify-center align-center">
        <v-btn color="primary" class="mx-2" large to="/change-password">Изменить пароль</v-btn>
        <v-btn color="primary" class="mx-2" large to="/update-profile">Изменить данные</v-btn>
        <v-btn color="error" class="mx-2" large @click="logout">Выйти</v-btn>
      </v-row>
    </v-container>
  </template>
