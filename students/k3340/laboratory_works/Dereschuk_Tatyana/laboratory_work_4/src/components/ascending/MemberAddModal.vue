...
const formData = ref({alpinist: null, result: null, emergency_situations: null});

const emits = defineEmits(["update:modelValue", "submit"]);

function closeModal() {
  emits("update:modelValue", false);
  formData.value = {alpinist: null, result: null, emergency_situations: null};
}
