...
from .serializers import (
    EmployeeSerializer, AuthorSerializer, BookSerializer, BookCreateSerializer, BookAuthorSerializer,
...
class EditionViewSet(viewsets.ModelViewSet):
    queryset = Edition.objects.all().prefetch_related('edition_editors__editor', 'book__authors')
