...
class WorkSchedule(models.Model):
    ...
    participation = models.ForeignKey(Participation, on_delete=models.CASCADE, null=False, related_name='work_schedule')

    def __str__(self):
        return f'Work schedule from {self.start_time} to {self.end_time}; candidate {self.participation.client.firstname} {self.participation.client.lastname}'
