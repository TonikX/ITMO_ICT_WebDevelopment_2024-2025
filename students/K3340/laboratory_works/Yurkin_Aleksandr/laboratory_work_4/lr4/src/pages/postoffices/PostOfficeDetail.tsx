    ...
    return (
        <Container sx={{ mt: 4 }}>
            ...
            <Box sx={{ mb: 2 }}>
                ...
                <Typography variant="body1"><b>Номер отделения:</b> {office.office_number}</Typography>
                <Typography variant="body1"><b>Адрес:</b> {office.address}</Typography>
                <Typography variant="body1"><b>Дата добавления:</b> {new Date(office.created_at).toLocaleString()}</Typography>
                <Typography variant="body1"><b>Дата обновления:</b> {new Date(office.updated_at).toLocaleString()}</Typography>
            </Box>
            <Button
                variant="contained"
                color="primary"
