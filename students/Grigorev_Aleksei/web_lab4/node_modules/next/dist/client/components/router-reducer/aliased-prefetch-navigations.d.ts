 ...
 */
export declare function handleAliasedPrefetchEntry(state: ReadonlyReducerState, flightData: NormalizedFlightData[], url: URL, mutable: Mutable): false | import("./router-reducer-types").ReducerState;
/**
