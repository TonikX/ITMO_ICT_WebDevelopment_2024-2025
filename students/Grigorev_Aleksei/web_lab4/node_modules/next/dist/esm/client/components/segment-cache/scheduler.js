import { requestRouteCacheEntryFromCache, requestSegmentEntryFromCache, EntryStatus } from './cache';
 ...
 */ export function schedulePrefetchTask(key) {
 ...
 */ export function trackPrefetchRequestBandwidth(promiseForServerData) {
    inProgressRequests++;
    promiseForServerData.then(onPrefetchRequestCompletion, onPrefetchRequestCompletion);
}
const noop = ()=>{};
export function spawnPrefetchSubtask(promise) {
