...
const workshop = ref(props.workshop);
const rowNumber = ref(null);
const cageNumber = ref(null);
...
const save = async () => {
  try {
    await store.dispatch('CageStore/createCage', {
...
<template>
  ...
  <form @submit.prevent="save">
    ...
    <label>
      <span>Row:</span>
      <input type="number" v-model="rowNumber" required />
    </label>
    <label>
      <span>Cage:</span>
      <input type='number' v-model="cageNumber" required />
    </label>
