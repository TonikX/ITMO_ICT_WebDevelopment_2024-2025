...
Дальше нужно зарегистрировать таблицы модели данных в админ-панели.
![Регистация в админ-панели](images/registration_of_models.png)

Создаю в файле views.py (находится в папке приложения) представление (контроллер), который выводит из базы данных данные о владельце автомобиля. 
Все контроллеры связываю с html страничками.

**код из файла view.py:**
```python
