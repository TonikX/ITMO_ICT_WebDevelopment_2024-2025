<template>
  ...
  <div class="container">
    <button class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#deleteModal">Delete Vacancy</button>
  </div>
</template>
...
const handleDelete = async () => {
  ...
  try {
    const response = await axiosInstance.delete(`/vacancies/${vacancyID}/edit/`);
