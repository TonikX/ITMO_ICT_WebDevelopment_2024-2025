...
urlpatterns = [
    ...
    path('conference/<int:conf_pk>/speaker/<int:pk>/update/', speaker_view.SpeakerUpdate.as_view()),
    path('conference/<int:conf_pk>/speaker/<int:pk>/delete/', speaker_view.SpeakerDelete.as_view()),
    path('conference/<int:conf_pk>/auditor/', conference_view.ConferenceAuditor.as_view()),
