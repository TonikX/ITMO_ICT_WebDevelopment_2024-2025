...
import CreateAscent from './CreateAscent.vue';
...
<template>
    <CreateAscent @ascentCreated="fetchAscents" />
    <v-data-table :headers="headers" :items="ascents" :loading="loading" @click:row="handleRowClick"
