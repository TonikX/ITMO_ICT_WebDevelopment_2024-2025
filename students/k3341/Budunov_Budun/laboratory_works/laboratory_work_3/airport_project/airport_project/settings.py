...
SECRET_KEY = 'django-insecure-ke_45kn4*m1@-uq%9t@s%juch#v8u!q3mo$yel0r-s)fki0f(*'
...
AUTH_USER_MODEL = "airport_app.CustomUser"

# djoser and jwt

REST_FRAMEWORK = {
    'DEFAULT_PERMISSION_CLASSES': [
        'rest_framework.permissions.IsAuthenticated',  # Доступ по умолчанию только для аутентифицированных пользователей
    ],
