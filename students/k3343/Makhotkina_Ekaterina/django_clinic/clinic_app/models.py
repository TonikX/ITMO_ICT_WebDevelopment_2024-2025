...
class Diagnosis(models.Model):
    diagnosis_type_enum = [
        ('circulatory diseases', 'Болезни системы кровообращения'),
        ('respiratory diseases', 'Болезни органов дыхания'),
        ('digestive diseases', 'Болезни органов пищеварения'),
        ('musculoskeletal diseases', 'Заболевания опорно-двигательного аппарата'),
        ('urinary diseases', 'Болезни мочевыводящих путей'),
        ('blood diseases', 'Заболевания крови'),
        ('endocrine diseases', 'Заболевания эндокринной системы'),
    ]
