...
**Общий** срок сдачи: **30.09.2024** (включительно) (необходимо отправить pull-реквест с работой). Вес работы в баллах – 12,5. Выполнение пунктов 1-5 - 100%. После срока сдачи максимальный бал 6.
